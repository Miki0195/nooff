        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div>
            ...
            <a
              ...
              className="block text-sm text-[#888888] hover:text-[#f5f5f5] transition-colors duration-200"
            >
              hello@nooffstudio.hu
            </a>
            <a
              href="tel:+36301234567"
              className="block mt-2 text-sm text-[#888888] hover:text-[#f5f5f5] transition-colors duration-200"
            >
              +36 30 123 4567
            </a>
            <div className="flex items-center gap-4 mt-6">
              {SOCIAL_LINKS.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="text-[#888888] hover:text-[#c8102e] transition-colors duration-200"
